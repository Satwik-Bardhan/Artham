    ...
    private void showAddCategoryDialog(CategoryModel categoryToEdit) {
        ...
        dialog.getButton(AlertDialog.BUTTON_NEUTRAL).setOnClickListener(v -> {
            ColorPickerDialogBuilder
                    ...
                    .initialColor(android.graphics.Color.parseColor(tempColorHex[0]))
                    .wheelType(ColorPickerView.WHEEL_TYPE.FLOWER)
                    .density(12)
                    .setPositiveButton("Select", (d, lastSelectedColor, allColors) -> {
                        tempColorHex[0] = String.format("#%06X", (0xFFFFFF & lastSelectedColor));
                    })
                    .build()
                    .show();
        });
